...
echo -e " ${BLUE}#${NC}                                Лабораторная работа № 5                                             ${BLUE}#${NC} "
echo -e " ${BLUE}#${NC}                              Алгоритм Кнута-Морриса-Пратта                                         ${BLUE}#${NC} "
echo -e " ${BLUE}#${NC}                                                                                                    ${BLUE}#${NC} "
echo -e " ${BLUE}#${NC}                                                                                                    ${BLUE}#${NC} "
...
if [[ $? != 0 ]];
then
	echo -e "$w1 Error to run CMake. Check version of CMake and GTest (see README.md)"
	exit 1
else
	echo
fi
...
if [[ $? != 0 ]];
then
	echo -e "$w1 Error to build project."
	exit 1
else
	echo
fi
